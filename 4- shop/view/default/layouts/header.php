...
<head>
    ...
    name='viewport'/>
    <title>ایزی شاپ</title>
    <!--    font------------------------------------>
    <link rel="stylesheet" href="public/css/default/font-awesome.min.css">
    <!-- <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.3.0/css/all.min.css" integrity="sha512-SzlrxWUlpfuzQ+pcUCosxcglQRNAq/DZjVsC0lE40xsADsfeQoEypE+enwcOiGjk/bSuGGKHEyjSoQ1zVisanQ==" crossorigin="anonymous" referrerpolicy="no-referrer" /> -->
    <link rel="stylesheet" href="public/css/default/materialdesignicons.css">
    <link rel="stylesheet" href="public/css/default/materialdesignicons.css.map">
    <!--    bootstrap------------------------------->
    <link rel="stylesheet" href="public/css/default/bootstrap.css">
    <!--    owl.carousel---------------------------->
    <link rel="stylesheet" href="public/css/default/owl.carousel.min.css">
    <!-- sweetalert2-------------------------------->
    <link rel="stylesheet" href="public/css/default/sweetalert2.min.css">
    <!--    responsive------------------------------>
    <link rel="stylesheet" href="public/css/default/responsive.css">
    <!--    main style------------------------------>
    <link rel="stylesheet" href="public/css/default/main.css">
</head>
<body>
<!--header------------------------------------->
    <header>
        ...
        <div class="container-main">
            <div class="col-lg-8 col-md-8 col-xs-12 pull-right">
                <div class="header-right">
                    <div class="logo">
                        <a href="#"><img src="public/images/default/logo.png"></a>
                    </div>
                        ...
                        <div class="search-header">
                            <form action="#">
                                ...
                                <button type="submit" class="button-search">
                                    <img src="public/images/default/search.png">
                                </button>
                            </form>
                ...
                <div class="header-left">
                    <ul class="nav-lr">
                        <li class="nav-item-account">
                            <a href="#">
                                <img src="public/images/default/user.png" alt="user">
                                حساب کاربری
            ...
            <div class="container-main">
                <div>
                    <ul class="list-menu">
                            ...
                            <ul class="sub-menu">
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                       <img src="public/images/default/menu/icon/carpet.png">
                                        فروش تابلو فرش
                                    </a>
                                    <ul class="megamenu-level-3" style="display:block">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="public/images/default/menu/ryan-christodoulou-789566-unsplash.jpg">
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="public/images/default/menu/icon/necklace.png">
                                        طلا و جواهر
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="public/images/default/menu/Jewelry.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="public/images/default/menu/icon/digital.png">
                                        کالای دیجیتال
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="public/images/default/menu/311-3114215_macbook-pro-office-photography.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="public/images/default/menu/icon/dishes.png">
                                        ظروف
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="public/images/default/menu/viennese_waffles_waffles_fruits_178672_1920x1080.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="public/images/default/menu/icon/dress.png">
                                        پوشاک
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="public/images/default/menu/190-1900787_image-may-contain-clothing-apparel-boutique-and-shop.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <li class="list-item-children">
                                    <a href="#" class="list-item-children-category">
                                        <img src="public/images/default/menu/icon/couch.png">
                                        خانه و آشپزخانه
                                    </a>
                                    <ul class="megamenu-level-3">
                                        ...
                                        <li class="images-menu-list">
                                            <a href="#">
                                                <img src="public/images/default/menu/sofa_decoration_interior_vase_lamp_white_background_80205_1920x1080.jpg">
                                                <div class="box-shadow"></div>
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <li class="item-list-menu megamenu">
                            <a href="#" class="list-category">ایزی شاپ من</a>
                        </li>
                        <li class="item-list-menu megamenu">
                                                    ...
                                                    <a href="#">
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="public/images/default/cart/lenovo-ideapadl3-15iml05.jpg">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="public/images/default/cart/huawei-p40pro.jpg">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="public/images/default/cart/asus-ZenBookDuo-UX481FL.jpg">
                                                        ...
                                                        <li class="dropdown-item">
                                                            <div class="title-cart">
                                                                <img src="public/images/default/cart/galaxy-watch-active2.jpg">
...
<!--              <img class="pic-header" src="images/header-pic.jpg" alt="">-->
              ...
              <div class="logo-wrap">
                <a class="logo-icon" href="#"><img alt="logo-icon" src="public/images/default/logo.png" width="40"></a>
              </div>
            </div>
