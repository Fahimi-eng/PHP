	...
	<div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
							<div class="card  box-shadow-0 ">
								...
								<div class="card-body pt-0">
									<form method="post" action="index.php?c=procat&a=store">
										<div class="">
											<div class="form-group">
												<label for="title">عنوان دسته بندی</label>
												<input name="title" type="text" class="form-control" id="title" placeholder="عنوان دسته بندی">
											</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="chid" class="form-control select2-no-search select2-hidden-accessible" data-select2-id="13" tabindex="-1" aria-hidden="true">
											        ...
											        <option value="<?php echo $item['id']; ?>" data-select2-id="27">
											        	<?php echo $item['title'];  ?>
											        </option>
                                                    <?php endforeach;  ?>
										        </select>
										...
										<button type="submit" class="btn btn-primary mt-3 mb-0">ایجاد</button>
									</form>
								</div>
							</div>
						</div>
