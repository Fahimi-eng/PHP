			...
			<div class="container-fluid">
				<div class="main-header-left ">
					<div class="responsive-logo">
						<a href="index.html"><img src="public/images/admin/brand/logo.png" class="logo-1" alt="لوگو"></a>
						<a href="index.html"><img src="public/images/admin/brand/logo-white.png" class="dark-logo-1" alt="لوگو"></a>
						<a href="index.html"><img src="public/images/admin/brand/favicon.png" class="logo-2" alt="لوگو"></a>
						<a href="index.html"><img src="public/images/admin/brand/favicon.png" class="dark-logo-2" alt="لوگو"></a>
					</div>
				...
				<div class="main-header-right">
								...
								<a href="#" class="d-flex  nav-item country-flag1"
								   data-bs-toggle="dropdown" aria-expanded="false">
											<span class="avatar country-Flag me-0 align-self-center bg-transparent"><img
													src="public/images/admin/flags/us_flag.jpg" alt="img"></span>
									<div class="my-auto">
								...
								<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow"
									...
									<a href="#" class="dropdown-item d-flex ">
												<span class="avatar  m-e-c-3 align-self-center bg-transparent"><img
														src="public/images/admin/flags/french_flag.jpg" alt="img"></span>
										<div class="d-flex">
									...
									<a href="#" class="dropdown-item d-flex">
												<span class="avatar  m-e-c-3 align-self-center bg-transparent"><img
														src="public/images/admin/flags/germany_flag.jpg" alt="img"></span>
										<div class="d-flex">
									...
									<a href="#" class="dropdown-item d-flex">
												<span class="avatar  m-e-c-3 align-self-center bg-transparent"><img
														src="public/images/admin/flags/italy_flag.jpg" alt="img"></span>
										<div class="d-flex">
									...
									<a href="#" class="dropdown-item d-flex">
												<span class="avatar  m-e-c-3 align-self-center bg-transparent"><img
														src="public/images/admin/flags/russia_flag.jpg" alt="img"></span>
										<div class="d-flex">
									...
									<a href="#" class="dropdown-item d-flex">
												<span class="avatar  m-e-c-3 align-self-center bg-transparent"><img
														src="public/images/admin/flags/spain_flag.jpg" alt="img"></span>
										<div class="d-flex">
					...
					<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown-menu">
								...
								<div class="main-message-list chat-scroll">
									<a href="#" class="p-3 d-flex border-bottom">
										<div class="  drop-img  cover-image  " data-bs-image-src="public/images/admin/faces/3.jpg">
									...
									<a href="#" class="p-3 d-flex border-bottom">
										<div class="drop-img cover-image" data-bs-image-src="public/images/admin/faces/2.jpg">
											<span class="avatar-status bg-teal"></span>
										</div>
										<div class="wd-90p">
											<div class="d-flex">
									...
									<a href="#" class="p-3 d-flex border-bottom">
										<div class="drop-img cover-image" data-bs-image-src="public/images/admin/faces/9.jpg">
											<span class="avatar-status bg-teal"></span>
										</div>
										<div class="wd-90p">
											<div class="d-flex">
						...
						<div class="dropdown main-profile-menu nav nav-item nav-link">
							<a class="profile-user d-flex" href="#"><img alt="" src="public/images/admin/faces/6.jpg"></a>
							<div class="dropdown-menu">
								<div class="main-header-profile bg-primary p-3">
									<div class="d-flex wd-100p">
										<div class="main-img-user"><img alt="" src="public/images/admin/faces/6.jpg" class=""></div>
